...
public class CharacterStats : MonoBehaviour
{
    ...
    [Header("Major stats")]
    public Stat strength; // 1 point naikin damage 1 sama critical chance 1%
    public Stat agility;  // 1 point naikin evasion jadi 1% ama crit.chance jadi 1%
    public Stat intelligence; // 1 point increase magic damage jadi 1 and magic resistance jadi 3
    public Stat vitality; // 1 point naikin HP jadi 5 points

    [Header("Offensive stats")]
    public Stat damage;
    public Stat critChance;
    public Stat critPower;              // default valuenya 150%
